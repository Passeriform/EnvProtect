...
class DecompressMemMapReader(LazyMixin):
    max_read_size: Any = ...
    def __init__(self, m: Any, close_on_deletion: Any, size: Optional[Any] = ...) -> None: ...
    def __del__(self) -> None: ...
    @classmethod
    def new(self, m: Any, close_on_deletion: bool = ...): ...
    def data(self): ...
    def close(self) -> None: ...
    def compressed_bytes_read(self): ...
    def seek(self, offset: Any, whence: Any = ...) -> None: ...
    def read(self, size: int = ...): ...

class DeltaApplyReader(LazyMixin):
    k_max_memory_move: Any = ...
    def __init__(self, stream_list: Any) -> None: ...
    def read(self, count: int = ...): ...
    def seek(self, offset: Any, whence: Any = ...) -> None: ...
    @classmethod
    def new(cls, stream_list: Any): ...
    @property
    def type(self): ...
    @property
    def type_id(self): ...
