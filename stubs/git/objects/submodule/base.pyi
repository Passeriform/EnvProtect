...
class Submodule(IndexObject, Iterable, Traversable):
    ...
    @classmethod
    def add(cls, repo: Any, name: Any, path: Any, url: Optional[Any] = ..., branch: Optional[Any] = ..., no_checkout: bool = ..., depth: Optional[Any] = ..., env: Optional[Any] = ...): ...
    def update(self, recursive: bool = ..., init: bool = ..., to_latest_revision: bool = ..., progress: Optional[Any] = ..., dry_run: bool = ..., force: bool = ..., keep_going: bool = ..., env: Optional[Any] = ...): ...
    path: Any = ...
    ...
    def children(self): ...
    @classmethod
    def iter_items(cls, repo: Any, parent_commit: str = ...) -> None: ...
